				...
				<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
					...
					<footer class="entry-meta">
						<?php
							...
							if ( '' != $tag_list ) {
								$utility_text = __( 'This entry was posted in %1$s and tagged %2$s. Bookmark the <a href="%3$s" title="Permalink to %4$s" rel="bookmark">permalink</a>.', 'justcss' );
							} else {
								$utility_text = __( 'This entry was posted in %1$s. Bookmark the <a href="%3$s" title="Permalink to %4$s" rel="bookmark">permalink</a>.', 'justcss' );
							}
							printf(
								$utility_text,
