...
function justcss_comment( $comment, $args, $depth ) {
		...
		<article id="comment-<?php comment_ID(); ?>" class="comment">
			<footer>
				<div class="comment-author vcard">
					...
					<?php printf( __( '%s <span class="says">says:</span>', 'justcss' ), sprintf( '<cite class="fn">%s</cite>', get_comment_author_link() ) ); ?>
				...
				<div class="comment-meta commentmetadata">
					...
					<?php
						...
						printf( __( '%1$s at %2$s', 'justcss' ), get_comment_date(),  get_comment_time() ); ?>
					</time></a>
					<?php edit_comment_link( __( '(Edit)', 'justcss' ), ' ' );
					?>
	...
	<li class="post pingback">
		<p><?php _e( 'Pingback:', 'justcss' ); ?> <?php comment_author_link(); ?><?php edit_comment_link( __('(Edit)', 'justcss'), ' ' ); ?></p>
	<?php
			break;
	endswitch;
}
...
?>
	...
	<?php if ( have_comments() ) : ?>
		<h2 id="comments-title">
			<?php
			    printf( _n( 'One Response to %2$s', '%1$s Responses to %2$s', get_comments_number(), 'justcss' ),
		...
		<nav id="comment-nav-above">
			...
			<div class="nav-previous"><?php previous_comments_link( __( '&larr; Older Comments', 'justcss' ) ); ?></div>
